...
```json5
{
  ...
  model: "gpt-5.5-pro", // browser alias for ChatGPT Latest; API defaults still use gpt-5.4-pro
  search: "on", // "on" | "off"
...
- Defaults: `auto` = 60 m for Pro API models; non-pro API models use `120s` if you don’t set a value.
