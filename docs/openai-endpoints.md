...
- `gpt-5.1-pro`, `gpt-5.2-pro` → `gpt-5.4-pro` (OpenAI API model ID)

Notes:

- `gpt-5.1-pro` and `gpt-5.2-pro` are **CLI aliases** for Oracle’s configured Pro API model ID: `gpt-5.4-pro`.
